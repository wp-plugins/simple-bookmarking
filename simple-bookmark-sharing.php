...
Plugin URI: http://www.phpbits.info/wordpress-plugins/wp-simple-bookmarking-plugin/
...
"chatintamil" => "http://www.chatintamil.org/submit?url=".$posturl
);
...
$bwidget .= '<a rel="nofollow" target="_blank" title="'.$site.'" href="'.$data.'"><img src="'.$site_url.'/wp-content/plugins/simple-bookmarking/images/'.$site.'.gif" alt="'.$site.'" ></a> | ';
}
